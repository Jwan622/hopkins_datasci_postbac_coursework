...
class HourlyEmployee extends Employee {
    ...
    public double calculateEarnings() {
        if (hoursWorked > 40) {
            ...
            return (40 * hoursWorked) + (overtime * 1.5);
        }
...
public class EmployeeWageDataStore {
    public static void main(String args[]) throws IOException {
        ...
        // put all employees in an Employee Array. This is legal because Employee is the super class.
    ...
    // simply calls the toString() method on the employee. Example of polymorphism.
